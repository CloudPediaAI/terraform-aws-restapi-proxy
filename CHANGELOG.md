...
### Added
- New `binary_media_types` variable to configure binary media types for API Gateway (default: `[]`)
- Support for handling binary content types like `multipart/form-data` through the API Gateway

### Improved
- Enhanced file upload and binary data handling capabilities
- Better support for form submissions with binary content
